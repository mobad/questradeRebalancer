...
showOrders = subparsers.add_parser('showOrders', help='Shows the orders that would be make')
...
placeOrders = subparsers.add_parser('spendAllMyMoney', help='Places orders to rebalance your account')
